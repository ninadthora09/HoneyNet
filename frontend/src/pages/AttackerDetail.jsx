    ...
    async function fetchDossier() {
      try {
        const res = await axios.get(
          `${import.meta.env.VITE_API_URL}/api/attackers/${ip}`,
        );
    ...
    <div className="min-h-screen bg-[#030712] p-6 space-y-6 text-white">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <h1 className="text-4xl font-black">Attacker Dossier</h1>
              </div>
            </div>
          ...
          <div className="w-full lg:w-[260px] rounded-2xl border border-slate-800 bg-black/30 backdrop-blur-xl p-6">
            ...
            <p className="text-slate-500 text-sm mt-4">
              Based on attack frequency, credentials, behavior patterns, and
              sensor activity.
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        <div className="bg-[#080f1a] border border-slate-800 rounded-2xl p-5">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-slate-400 font-medium">Total Attacks</h3>
          </div>
        ...
        <div className="bg-[#080f1a] border border-slate-800 rounded-2xl p-5">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-slate-400 font-medium">Origin Country</h3>
          </div>
        ...
        <div className="bg-[#080f1a] border border-slate-800 rounded-2xl p-5">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-slate-400 font-medium">Fingerprint</h3>
          </div>
      ...
      <div className="bg-[#080f1a] border border-slate-800 rounded-3xl p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl font-bold">Credentials Tried</h2>
        </div>
      ...
      <div className="bg-[#080f1a] border border-slate-800 rounded-3xl p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl font-bold">Commands Executed</h2>
        </div>
            ...
            {dossier.commands.map((cmd, index) => (
              ...
              >
                ...
                <div className="p-5 font-mono">
                  <p className="text-cyan-400">$ {cmd.command}</p>
              ...
              <div className="bg-slate-900/40 border border-slate-800 rounded-2xl p-5">
                <div className="flex justify-between items-center flex-wrap gap-3">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-slate-500 text-sm">Threat Score</span>

                    <span className={threatColor}>{attack.threatScore}</span>
                  </div>
