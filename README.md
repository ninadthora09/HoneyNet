...
> “I built a real-time honeypot intelligence platform using Node.js, MongoDB, Socket.io, and React. The system deploys fake SSH and HTTP services that attract attackers, capture their behavior, calculate threat scores, fingerprint their activity, and stream everything live to a dashboard with attack maps, session replay, and credential intelligence.”

---

## “Why Node.js?”

> “Node.js is excellent for event-driven real-time systems and handles Socket.io connections efficiently. Using Node.js everywhere also simplified the architecture.”

---

## “Why MongoDB?”

> “Attack events are semi-structured and vary significantly. MongoDB’s flexible schema is ideal for this kind of data.”

---

## “What problem does this solve?”

> “Traditional security systems are reactive. Honeypots are proactive intelligence systems that reveal what attackers are actively targeting.”
